...
export function Footer() {
  return (
    <footer className="mt-8 bg-foreground text-background">
      <div className="mx-auto grid max-w-[430px] grid-cols-2 gap-8 px-4 py-10 sm:max-w-2xl md:max-w-4xl lg:max-w-5xl lg:grid-cols-4 lg:gap-6 lg:px-8">
      ...
      <div className="mx-auto max-w-[430px] border-t border-background/15 px-4 py-4 text-center text-[11px] text-background/50 sm:max-w-2xl md:max-w-4xl lg:max-w-5xl lg:px-8">
